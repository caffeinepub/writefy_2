    ...
    >
      ...
      {tab === "write" ? (
        <div className="flex flex-col flex-1 px-4 pt-4">
          ...
          >
            {project.type === "Novel" ? (
              // ── NOVEL: contentEditable div for real rich-text formatting ─────
              <div
                ref={novelEditorRef}
                ...
                onInput={(e) => {
                  ...
                  setSaveStatus("Unsaved changes");
                  // Debounce: don't call persistProject on every keystroke
                  if (saveTimer.current) clearTimeout(saveTimer.current);
                  // Just mark dirty; user saves manually
                  void html;
                  // Typewriter mode for novel
                  if (typewriterMode) {
