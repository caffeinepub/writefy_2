...
function App() {
  ...
  function exportAsEpub() {
    // EPUB as a structured HTML with correct MIME — opens in most e-readers/browsers
    const content = currentProject?.content || "";
    const projTitle = currentProject?.title || "Untitled";
...
<body>
  ...
  function handleMenuImport(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = (ev) => {
      ...
      if (!text) return;
      if (currentProject) {
        // Replace content of current project
        const updated = {
          ...currentProject,
          content: text,
          lastEdited: Date.now(),
        ...
        // Create a new project named after the file
      ...
      {showCreatePicker && (
        ...
        >
          ...
          >
            ...
            {/* 3 options in 2-column + 1 full row */}
            <div
              style={{
                display: "grid",
